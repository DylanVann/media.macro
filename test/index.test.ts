...
describe('index', function() {
    ...
    it('replaces import statements with uri', function() {
        ...
        chai.expect(result).to.equal(`const test = '/public/9c87cbf3ba33126ffd25ae7f2f6bbafb.png';`)
    })
    ...
    it('handles custom import path', function() {
        ...
        chai.expect(result).to.equal(`const test = '/static/9c87cbf3ba33126ffd25ae7f2f6bbafb.png';`)
    })
    ...
    it('handles custom name', function() {
        ...
        chai.expect(result).to.equal(`const test = '/public/test/assets/file.png';`)
    })
    ...
    it('handles custom context', function() {
        ...
        chai.expect(result).to.equal(`const test = '/public/assets/file.png';`)
    })
    ...
    it('handles custom context v2', function() {
        ...
        chai.expect(result).to.equal(`const test = '/public/file.png';`)
    })
    ...
    it('handles name with custom hash length', function() {
        ...
        chai.expect(result).to.equal(`const test = '/public/9c87cbf3.png';`)
    })
    ...
    it('handles base26 digest', function() {
        ...
        chai.expect(result).to.equal(`const test = '/public/ccjesbcwzsppzgsqtbnioeblcexw.png';`)
    })
    ...
    it('handles base32 digest', function() {
        ...
        chai.expect(result).to.equal(`const test = '/public/8vrapkyzxf5ryqy5jmrctwr2ww.png';`)
    })
    ...
    it('handles base36 digest', function() {
        ...
        chai.expect(result).to.equal(`const test = '/public/ewi6kgnxju4v6e6xs91ffh3mk.png';`)
    })
    ...
    it('handles base49 digest', function() {
        ...
        chai.expect(result).to.equal(`const test = '/public/wUByBoCTfZTTYAcdFceBFjM.png';`)
    })
    ...
    it('handles base52 digest', function() {
        ...
        chai.expect(result).to.equal(`const test = '/public/fVWKlApuFbbEMdlLegCqBlW.png';`)
    })
    ...
    it('handles base58 digest', function() {
        ...
        chai.expect(result).to.equal(`const test = '/public/x5UajugYgSHCpqHbQXrw1d.png';`)
    })
    ...
    it('handles base62 digest', function() {
        ...
        chai.expect(result).to.equal(`const test = '/public/7F0gARBRl8UjBzQkyqrDyY.png';`)
    })
    ...
    it('handles base64 digest', function() {
        ...
        chai.expect(result).to.equal(`const test = '/public/3XKCILvWUB_mYicXHPOUus.png';`)
    })
    ...
    it('handles hash as query param', function() {
        ...
        chai.expect(result).to.equal(`const test = '/public/test/assets/file.png?9c87cbf3';`)
    })
    ...
    it('should replace require statements with uri', function() {
        ...
        chai.expect(result).to.equal(`const test = '/public/64eababb117f90535085779cc0325003.svg';`)
    })
    ...
    it('should replace require statements even without assignment', function() {
        ...
        chai.expect(result).to.equal(`'/public/64eababb117f90535085779cc0325003.svg';`)
    })
...
`)
    ...
    it('should do nothing when imports have no extensions', function() {
        ...
        chai.expect(result).to.equal(`import test from 'something';`)
    })
    ...
    it('should do nothing when require have no extensions', function() {
        ...
        chai.expect(result).to.equal(`const test = require('something');`)
    })

    it('should do nothing when not a require assignment', function() {
        const result = transformCode(getFixtures('require-var.js')).code
        chai.expect(result).to.equal(`const test = 'something';`)
    })

    it('outputs file in outputPath', function() {
        transformCode(getFixtures('import-image.js')).code
        chai.expect(
            fs.existsSync(path.resolve(__dirname, './public/9c87cbf3ba33126ffd25ae7f2f6bbafb.png')),
        ).to.equal(true)
    })
    ...
    it('outputs file in outputPath, nested', function() {
        ...
        chai.expect(
            fs.existsSync(
                path.resolve(__dirname, './public/foo/bar/9c87cbf3ba33126ffd25ae7f2f6bbafb.png'),
            ),
        ).to.equal(true)
    })
